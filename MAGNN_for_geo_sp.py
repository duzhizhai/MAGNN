...
hid_units = [32]        # n umbers of hidden units per each attention head in each layer
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(nb_epochs):
            ...
            train_feed_dict = {ftr_in: features[0:1],  bias_in: bbias, lbl_in: y_train[0:1],
                               msk_in: train_mask[0:1], is_train: True, attn_drop: 0.2, ffd_drop: 0.2}
            ...
            print('epoch %d\t Training: loss = %.5f, acc_classify = %.5f, acc@161 = %.5f | '
                  ...
                  (epoch, loss_value_tr, acc_classify_tr, acc161_tr, loss_value_vl, acc_classify_vl, acc161_vl))
